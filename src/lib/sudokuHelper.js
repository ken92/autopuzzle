// Source: https://github.com/robatron/sudoku.js/blob/master/sudoku.js
/*
    Sudoku.js
    ---------
...
const sudoku = (function(root){
    ...
    // Return the sudoku object from the IIFE so we can export it
    return sudoku;

// Pass the global object (works in browser and Node-like envs)
})(typeof globalThis !== "undefined" ? globalThis : (typeof window !== "undefined" ? window : this));

export default sudoku;
// Also export named helpers for convenience in TypeScript/ES imports
export const solve = sudoku.solve;
export const generate = sudoku.generate;
export const get_candidates = sudoku.get_candidates;
